...
?>
<?php if(isset($gflp->messages['upload']) && is_array($gflp->messages['upload']) && count($gflp->messages['upload']) > 0): ?>
<div class="updated">
<p class="">
<?php foreach($gflp->messages['upload'] as $msg): ?>
	<span><?php print $msg; ?></span><br/>
<?php endforeach;?>
</p>
</div>
<?php endif; ?>
<script type="text/javascript">var flp_current_album_id = <?php print $album['album_id']; ?>;</script>
<div class="dataTable_wrapper">
	<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
		...
		<?php flp_get_table_actions(array('flp_bulk_delete_images' => 'Delete', 
											'flp_bulk_disable_images' => 'Disable', 
											'flp_bulk_enable_images' => 'Enable')); ?>
	</div>
	...
	<tbody>
	<?php require_once FLP_PLUGIN_DIR . '/html/images_rows.php'; ?>
	</tbody>
	</table>
...
<div id="single_upload" class="tab_content">
	<form id="single_upload_form" action="" method="post" enctype="multipart/form-data">
		<input type="hidden" name="task" value="flp_single_image_upload" />
...
-->
	...
	var flp_upload_dir = "<?php  /* add the replace "\\" to work on windows server */  print str_replace("\\","/",flp_get_album_dir($album['album_id'])); ?>";
	var flp_secw = "<?php 
	global $wpdb;
	$query = "SELECT txt FROM {$wpdb->prefix}flp_misc WHERE ione=1 AND itwo=1 AND ithree=1 LIMIT 1";
